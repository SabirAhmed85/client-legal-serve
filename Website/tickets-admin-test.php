    ...
    <div class="main-page-container">
	  <div class="main-page-container-inner">
          <div class="main-left-container">
            <h1>View Service Tickets</h1>
            <div data-link="/ticket-admin-test.php?_itemId=" data-item-type="Business Item" data-bid="32" data-item-extra-filters="[['Business Item Type':='Service Ticket']]" data-item-sub-type="Business item Type,Service Ticket" class="mynyte-business-items-summary" style="width: 800px; display: none;"></div>
          </div>
