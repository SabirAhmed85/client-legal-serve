    ...
    <div class="main-page-container">
	  <div class="main-page-container-inner">
        <div class="main-left-container">
          <h1>Add a New Tennant</h1>
          <div data-link="/tennants-admin-test.html" data-item-type="Business Item" data-bid="32" data-item-extra-filters="'Related Business Entity Specific Item Type':='Tennant'" data-item-sub-type="Business Item Type,Tennant" class="mynyte-new-business-item mn-dark" style="width: 1100px; display: none;"></div>
        </div>
