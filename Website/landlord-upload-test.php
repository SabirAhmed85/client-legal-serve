    ...
    <div class="main-page-container">
	  <div class="main-page-container-inner">
        <div class="main-left-container">
          ...
          <div  data-link="/landlords-admin-test.html" data-item-type="Business Item" data-bid="32" data-item-extra-filters="'Related Business Entity Specific Item Type':='Landlord'" data-item-sub-type="Specific Item Type,Landlord" class="mynyte-new-business-item" style="width: 1100px; display: none;"></div>
        </div>
