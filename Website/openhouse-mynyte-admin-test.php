	  ...
	  <div class="main-page-container-inner">
        <div class="admin-section-wrapper main-left-container">
          ...
          <div class="admin-section">
            <div class="admin-section-header">
              <h2>
                <i class="fa fa-phone-square left-icon"></i>Property Enquiries
                <i class="fa fa-arrow-up" onclick="showSubSection(this)"></i>
              </h2>
            </div>
            <div class="admin-section-body open trans">
              <a href="unread-enquiries-admin-test.php">
                <i class="fa fa-phone-square trans"></i>
                <span>Unread Enquiries</span>
              </a>
              <a href="enquiries-admin-test.php">
                <i class="fa fa-phone trans"></i>
          ...
          <div class="admin-section">
            <div class="admin-section-header">
              <h2>
                <i class="fa fa-building left-icon"></i>Properties
                <i class="fa fa-arrow-up" onclick="showSubSection(this)"></i>
              </h2>
            </div>
            <div class="admin-section-body open trans">
              <a href="properties-admin-test.php">
                <i class="fa fa-building trans"></i>
                <span>Properties</span>
              </a>
              <a href="property-upload-test.php">
                <i class="fa fa-plus-square trans"></i>
          ...
          <div class="admin-section">
            <div class="admin-section-header">
              <h2>
                <i class="fa fa-key left-icon"></i>Landlords
                <i class="fa fa-arrow-up" onclick="showSubSection(this)"></i>
              </h2>
            </div>
            <div class="admin-section-body open trans">
              <a href="landlords-admin-test.php">
                <i class="fa fa-key trans"></i>
                <span>Landlords</span>
              </a>
              <a href="landlord-upload-test.php">
                <i class="fa fa-plus-square trans"></i>
          ...
          <div class="admin-section">
            <div class="admin-section-header">
              <h2>
                <i class="fa fa-users left-icon"></i>Tennants
                <i class="fa fa-arrow-up" onclick="showSubSection(this)"></i>
              </h2>
            </div>
            <div class="admin-section-body open trans">
              <a href="tennants-admin-test.php">
                <i class="fa fa-users trans"></i>
                <span>Tennants</span>
              </a>
              <a href="tennant-upload-test.php">
                <i class="fa fa-plus-square trans"></i>
                <span>New Tennant</span>
              </a>
            </div>
          </div>
          ...
          <div class="admin-section">
            <div class="admin-section-header">
              <h2>
                <i class="fa fa-cog left-icon"></i>Settings
                <i class="fa fa-arrow-up" onclick="showSubSection(this)"></i>
              </h2>
            </div>
            <div class="admin-section-body open trans">
              <a href="business-settings-test.php">
                <i class="fa fa-briefcase trans"></i>
                <span>Business Settings</span>
              </a>
              <a href="account-settings-test.php">
                <i class="fa fa-user-circle trans"></i>
                <span>Account Settings</span>
              </a>
              <a href="tennant-upload-test.html">
                <i class="fa fa-sign-out trans"></i>
                <span>Log Out</span>
              </a>
            </div>
          </div>
