    ...
    <div class="main-page-container">
	  <div class="main-page-container-inner">
        <div class="main-left-container">
          <h1>View Tennants</h1>
          <div data-link="/tennant-admin-test.php?_itemId=" data-item-type="Business Item" data-bid="32" data-item-extra-filters="[['Related Business Entity Specific Item Type':='Tennant']]" data-item-sub-type="Business item Type,Tennant" class="mynyte-business-items-summary mn-dark" style="width: 1100px; display: none;"></div>
        </div>
