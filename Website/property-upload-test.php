    ...
    <div class="main-page-container">
	  <div class="main-page-container-inner">
        <div class="main-left-container">
          ...
          <div data-link="/properties-admin-test.html" data-item-type="Catalogue Item" data-bid="32" data-item-extra-filters="'Related Business Entity Specific Item Type':='Property'" data-item-sub-type="Catalogue Item Type,Property" class="mynyte-new-business-item mn-dark" style="width: 1100px; display: none;"></div>
        </div>
