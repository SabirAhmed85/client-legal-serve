    ...
    <div class="main-page-container">
	  <div class="main-page-container-inner">
        <div class="main-left-container">
          <h1>View Unread Property Enquiries</h1>
          <div data-link="/enquiry-admin-test.php?_itemId=" data-item-type="Business Item" data-bid="32" data-item-extra-filters="[['Business Item Type':='Property Enquiry']],[['Viewed':=false]]" data-item-sub-type="Business item Type,Property Enquiry" class="mynyte-business-items-summary" style="width: 800px; display: none;"></div>
        </div>
