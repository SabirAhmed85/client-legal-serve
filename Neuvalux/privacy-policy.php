<html ng-app="NightLife" class="wf-quicksand-n4-active wf-quicksand-n7-active wf-active"><head>
  ...
  <body class="privacy-policy">
    ...
    <div style="opacity: 0;" class="page-container slow-trans">
        ...
        <div class="header-img header-top trans at-top">
        ...
        <div class="main-container-2 main-container main-container-dark-grey contact-summary">
            <div class="text">
                <h2 class="lower">Privacy Policy</h2>
                <p>If you require any more information or have any questions about our privacy policy, please feel free to contact us by email at <b>privacy@mynyte.co.uk</b></p>
                <p>At www.mynyte.co.uk we consider the privacy of our visitors to be extremely important. This privacy policy document describes in detail the types of personal information is collected and recorded by www.mynyte.co.uk and how we use it. </p>
                <p> <b>Log Files</b><br> 
                    Like many other Web sites, www.mynyte.co.uk makes use of log files. These files merely logs visitors to the site - usually a standard procedure for hosting companies and a part of hosting services's analytics. The information inside the log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date/time stamp, referring/exit pages, and possibly the number of clicks. This information is used to analyze trends, administer the site, track user's movement around the site, and gather demographic information. IP addresses, and other such information are not linked to any information that is personally identifiable. </p>
                <p> <b>Cookies and Web Beacons</b><br>
                    www.mynyte.co.uk does not use cookies. </p>

                <p><strong>Children's Information</strong><br />
                    We believe it is important to provide added protection for children online. We encourage parents and guardians to spend time online with their children to observe, participate in and/or monitor and guide their online activity. www.mynyte.co.uk does not knowingly collect any personally identifiable information from children under the age of 15.  If a parent or guardian believes that www.mynyte.co.uk has in its database the personally-identifiable information of a child under the age of 15, please contact us immediately (using the contact in the first paragraph) and we will use our best efforts to promptly remove such information from our records.
                ...
                <p><b>Updates</b><br />
                    This Privacy Policy was last updated on: <b>Monday, March 20th, 2017</b>. Should we update, amend or make any changes to our privacy policy, those changes will be posted here.</em>
                    <br />
                </p>
            </div>
        </div>

        <div class="main-container-2 main-container main-container-white no-bottom-marg start-journey">
            <?php include_once("templates/contact-template.php"); ?>
        </div>
